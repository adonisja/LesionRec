# Setup Guide for LesionRec (Lumina)

This guide will walk you through setting up the LesionRec (Lumina) project, a full-stack application for skin analysis and product recommendation.
