...
# Create project
gcloud projects create lumina-adon-vision --name="LesionRec Vision"

# Set as active project
gcloud config set project lumina-adon-vision
...
gcloud billing projects link lumina-adon-vision \
...
gcloud iam service-accounts create lumina-adon-vision \
    --display-name="Lumina Vision Service Account"

# Grant Vision API permissions
gcloud projects add-iam-policy-binding lumina-adon-vision \
    --member="serviceAccount:lumina-adon-vision@lumina-adon-vision.iam.gserviceaccount.com" \
...
gcloud iam service-accounts keys create ./backend/vision-credentials.json \
    --iam-account=lumina-adon-vision@lumina-adon-vision.iam.gserviceaccount.com
