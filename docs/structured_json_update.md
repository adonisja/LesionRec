...
Updated the Gemini AI integration to use **structured JSON output** instead of unstructured text. This makes the system more reliable and easier to integrate with your frontend.
...
**Gemini Model**: 2.0 Flash (Experimental)
