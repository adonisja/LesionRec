# Technical Overview: Lumina (LesionRec)
...
Lumina is built on a decoupled client-server architecture, designed for scalability and privacy.
...
The core of Lumina is its two-stage AI pipeline, designed to prioritize user privacy while delivering accurate dermatological insights.
