@echo off
REM Lumina Development Server Startup Script (Windows)
REM This script starts both backend and frontend servers

echo.
echo ================================
echo Starting Lumina Development Environment...
echo ================================
echo.
...
cd backend
start "Lumina Backend" cmd /k "..\\.venv\\Scripts\\activate.bat && uvicorn src.main:app --host 0.0.0.0 --port 8000 --reload"
cd ..
