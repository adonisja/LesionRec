# LesionRec Data Management - Acne Detection

This directory contains all acne datasets, processed data, and models for the LesionRec project.
...
1. Check this README
2. Check [QUICK_START_ACNE.md](../QUICK_START_ACNE.md)
3. Search [DVC docs](https://dvc.org/doc)
4. Ask the team on Slack/Discord
5. Open an issue in the repo
